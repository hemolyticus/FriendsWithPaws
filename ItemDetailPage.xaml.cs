...
namespace FriendsWithPaws
{
    ...
    public sealed partial class ItemDetailPage : FriendsWithPaws.Common.LayoutAwarePage
    {
        ...
        private void OnReminderButtonClicked(object sender, RoutedEventArgs e)
        {            
            FirstToastMessage();
            SecondToastMessage();
        ...
        private async void SecondToastMessage()
        {
            ...
            toastTextElements[0].AppendChild(toastXml.CreateTextNode("Please check  what's new with Friends With Paws"));
            XmlNodeList toastImageAttributes = toastXml.GetElementsByTagName("image");
            ((XmlElement)toastImageAttributes[0]).SetAttribute("src", "/assets/logo.png");
            ...
            var date = DateTimeOffset.Now.AddSeconds(60);
        ...
        private async void FirstToastMessage()
        {
            var notifier = ToastNotificationManager.CreateToastNotifier();
