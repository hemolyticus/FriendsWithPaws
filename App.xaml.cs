...
namespace FriendsWithPaws
{
    ...
    sealed partial class App : Application
    {
        ...
        void OnSuggestionsRequested(SearchPane sender, SearchPaneSuggestionsRequestedEventArgs args)
        {
            ...
            string[] termsList = { "Beagle", "Pug", "Dachshund", "West Highland White Terrier", "Jack Russell Terrier", "Yorkshire Terrier", "Australian Sheperd", "Bulldog", "Basset Hound", "Shar Pei",
                             "Border Collie", "Springer Spaniel", "Dalmatian", "Golden Retriever", "Doberman Pinscher", "Great Dane", "German Sheperd", "Irish Seter" };
